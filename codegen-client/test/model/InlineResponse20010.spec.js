...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20010', function() {
      beforeEach(function() {
        instance = new BaseCaSeApiDraft.InlineResponse20010();
      });

      it('should create an instance of InlineResponse20010', function() {
        // TODO: update the code to test InlineResponse20010
        expect(instance).to.be.a(BaseCaSeApiDraft.InlineResponse20010);
      });
      ...
      it('should have the property people (base name: "people")', function() {
        // TODO: update the code to test the property people
        expect(instance).to.have.property('people');
        // expect(instance.people).to.be(expectedValueLiteral);
      });
