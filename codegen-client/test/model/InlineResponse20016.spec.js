...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20016', function() {
      beforeEach(function() {
        instance = new BaseCaSeApiDraft.InlineResponse20016();
      });

      it('should create an instance of InlineResponse20016', function() {
        // TODO: update the code to test InlineResponse20016
        expect(instance).to.be.a(BaseCaSeApiDraft.InlineResponse20016);
      });
      ...
      it('should have the property continents (base name: "continents")', function() {
        // TODO: update the code to test the property continents
        expect(instance).to.have.property('continents');
        // expect(instance.continents).to.be(expectedValueLiteral);
      });
