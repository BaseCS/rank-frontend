...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2009', function() {
      beforeEach(function() {
        instance = new BaseCaSeApiDraft.InlineResponse2009();
      });

      it('should create an instance of InlineResponse2009', function() {
        // TODO: update the code to test InlineResponse2009
        expect(instance).to.be.a(BaseCaSeApiDraft.InlineResponse2009);
      });

      it('should have the property institutions (base name: "institutions")', function() {
        // TODO: update the code to test the property institutions
        expect(instance).to.have.property('institutions');
        // expect(instance.institutions).to.be(expectedValueLiteral);
      });
